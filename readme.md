...
[(htmlcov/index.html)](https://github.com/lidiar8r-ops/homework/blob/homework_12_1/htmlcov/index.html)

Для запуска тестов воспользуйтесь командой  ```poetry```

## Новое
добавленs новыt модули:
1. модуль ```utils.py```, который принимает на вход путь до JSON-файла и возвращает список словарей с данными о финансовых 
транзакциях.
...
2. модуль ```external_api.py``` , который принимает на вход транзакцию и возвращает сумму этой транзакции в рублях. 
...
```
Так же файл с данными о финансовых транзациях **operations.json** добавлен в директорию data в корне проекта.
